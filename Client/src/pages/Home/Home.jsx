    ...
    <div className="home flex h-screen">
      <section className="l-side flex flex-col items-center p-7 justify-center gap-9">
        <div className="headings">
            <p className="flex flex-col text-8xl text font-semibold text-cyan-700">Finding <span>Balance</span> <span className="text-emerald-400">In Mental</span> <span className="text-lime-400">Wellness.</span></p>
        </div>
        ...
        <NavLink to="/" className="text-lime-400 uppercase font-extrabold bg-cyan-700 py-4 px-8 rounded-2xl w-11/12 text-center">Join us</NavLink>
      </section>
